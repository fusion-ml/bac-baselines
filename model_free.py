...
from stable_baselines3 import PPO2, SAC, TD3
...
def main(config):
    ...
    check_env(env)
    model_classes = {'PPO': PPO2, 'SAC': SAC, 'TD3': TD3}
    ...
    model.learn(total_timesteps=config.env.timesteps, callbacks=[eval_callback])
